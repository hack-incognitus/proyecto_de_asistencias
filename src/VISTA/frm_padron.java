...
import CONTROLADOR_3.c_padron;
import CONTROLADOR_3.c_sancion;
import CONTROLADOR_3.c_terreno;
import CONTROLADOR_3.c_usuario;
import static VISTA.frm_terreno.id_terreno_e;
import static VISTA.frm_terreno.lote_e;
 ...
 * @author lab-1 pc15
 */
public class frm_padron extends javax.swing.JFrame {
    ...
    c_padron ocPadron = new c_padron();
    ...
    public frm_padron() {
        ...
        txt_id_terreno.setEnabled(false);
        txt_terreno.setEnabled(false);
       // listar_sancion("");
...
public static String id_padron="";
    void limpiar() {
        txt_id.setText("");
        txt_id_terreno.setText("");
        txt_terreno.setText("");
        txtdate.setDatoFecha(null);
    }

    void listar_padron(String dato) {
        try {
            modelo=ocPadron.Listarpadron(dato);
    ...
    void insertar() {
        try {
            if (txt_id_terreno.getText().isEmpty() || txt_terreno.getText().isEmpty()) {
                ...
                ocPadron.insertarPadron(txt_id_terreno.getText(), fechastring);
            }
        } catch (Exception e) {
        }
    }
    ...
    void recuperar()  {
        ...
        txt_id_terreno.setText(modelo.getValueAt(select, 1).toString());
        try {
    ...
    void modificar() {
        try {
            if (txt_id.getText().isEmpty() || txt_id_terreno.getText().isEmpty()) {
                ...
                ocPadron.modificarPadron(txt_id.getText(), txt_id_terreno.getText(), fechastring);
            }
    ...
    void eliminar() {
        try {
            ...
            int select=tabla.getSelectedRow();
            if (select >= 0) {
                ocPadron.eliminarPadron(modelo.getValueAt(select, 0).toString());
                listar_padron("");
            } else {
            ...
            JOptionPane.showMessageDialog(null,"ocurio un error al eliminar "+ e);
        }
    }
    
    
    
    void recuperar_terreno() {
        try {
            frm_terreno frm = new frm_terreno();
            txt_id_terreno.setText(frm.id_terreno_e);
            txt_terreno.setText(frm.lote_e);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        txt_terreno = new rojeru_san.RSMTextFull();
        txt_id_terreno = new rojeru_san.RSMTextFull();
        ...
        jLabel1.setText("REGISTRO DE PADRONES");
        ...
        btn_usuario1.setText("ENVIAR");
        btn_usuario1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_usuario1ActionPerformed(evt);
            }
        });
        getContentPane().add(btn_usuario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 240, 200, 50));

        txt_id.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_id.setPlaceholder("id padron");
        ...
        getContentPane().add(btn_usuario3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, 210, 50));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 840, 270));

        txt_terreno.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_terreno.setPlaceholder("terreno");
        txt_terreno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_terrenoActionPerformed(evt);
            }
        });
        txt_terreno.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_terrenoKeyPressed(evt);
            }
        });
        getContentPane().add(txt_terreno, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 130, 260, -1));

        txt_id_terreno.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_id_terreno.setPlaceholder("id terreno");
        txt_id_terreno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_id_terrenoActionPerformed(evt);
            }
        });
        txt_id_terreno.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_id_terrenoKeyPressed(evt);
            }
        });
        getContentPane().add(txt_id_terreno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, 220, -1));
        ...
        getContentPane().add(txtdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 270, 40));

        btn_usuario4.setBackground(new java.awt.Color(0, 204, 255));
        btn_usuario4.setText("Registar");
        btn_usuario4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_usuario4ActionPerformed(evt);
            }
        });
        getContentPane().add(btn_usuario4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, 210, 50));

        btn8.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btn8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENES/terrenos_1.png"))); // NOI18N
        btn8.setText("IR ");
        ...
        getContentPane().add(btn8, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 130, 80, 40));

        btn_usuario2.setBackground(new java.awt.Color(0, 204, 255));
        btn_usuario2.setText("Eliminar");
        btn_usuario2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_usuario2ActionPerformed(evt);
            }
        });
        getContentPane().add(btn_usuario2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 240, 210, 50));
        ...
        getContentPane().add(btn_usuario5, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 240, 210, 50));
    ...
    private void btn_usuario1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_usuario1ActionPerformed
        ...
        int select = tabla.getSelectedRow();
        if (select >= 0) {
            id_padron = modelo.getValueAt(select, 0).toString();

            frm_socio frm_socio = new frm_socio();
            frm_socio.setVisible(true);
            this.dispose();
        } else {
    ...
    private void txt_terrenoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_terrenoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_terrenoKeyPressed
    ...
    private void txt_terrenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_terrenoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_terrenoActionPerformed
...
//        // TODO add your handling code here:
    ...
    private void txt_id_terrenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_id_terrenoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_id_terrenoActionPerformed

    private void txt_id_terrenoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_id_terrenoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_id_terrenoKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_padron.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_padron().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.RSMTextFull txt_id_terreno;
    private rojeru_san.RSMTextFull txt_terreno;
