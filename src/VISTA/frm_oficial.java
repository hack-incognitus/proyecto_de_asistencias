 ...
 * @author lab-1 pc15
 */
public class frm_oficial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_nombre_usuario = new rojeru_san.RSMTextFull();
        btn_usuario2 = new rojerusan.RSMaterialButtonRound();
        btn_usuario3 = new rojerusan.RSMaterialButtonRound();
        jScrollPane1 = new javax.swing.JScrollPane();
        dgvcliente = new rojerusan.RSTableMetro();
        txtcontra1 = new rojeru_san.RSMPassView();
        txtusuario1 = new rojeru_san.RSMTextFull();
        ...
        lcodigo.setText("Tipo usuario:");
        getContentPane().add(lcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, -1, 40));
        ...
        cbotipo.setForeground(new java.awt.Color(50, 105, 125));
        cbotipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione...", "Administrador", "Invitado", " " }));
        cbotipo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 176, 202), 2));
        getContentPane().add(cbotipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, 240, 40));

        txt_nombre_usuario.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_nombre_usuario.setPlaceholder("Nombre Usuario");
        txt_nombre_usuario.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_nombre_usuarioKeyPressed(evt);
            }
        });
        getContentPane().add(txt_nombre_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 320, -1));
        ...
        dgvcliente.setAltoHead(25);
        dgvcliente.setColorBackgoundHead(new java.awt.Color(102, 176, 202));
        dgvcliente.setColorBordeFilas(new java.awt.Color(255, 255, 255));
        dgvcliente.setColorBordeHead(new java.awt.Color(255, 255, 255));
        dgvcliente.setColorFilasBackgound2(new java.awt.Color(156, 204, 221));
        dgvcliente.setColorFilasForeground1(new java.awt.Color(102, 176, 202));
        dgvcliente.setColorFilasForeground2(new java.awt.Color(255, 255, 255));
        dgvcliente.setColorSelBackgound(new java.awt.Color(50, 105, 125));
        dgvcliente.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        dgvcliente.setFuenteHead(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dgvcliente.setGridColor(new java.awt.Color(255, 255, 255));
        dgvcliente.setGrosorBordeFilas(0);
        dgvcliente.setMultipleSeleccion(false);
        dgvcliente.setSelectionBackground(new java.awt.Color(255, 0, 0));
        dgvcliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dgvclienteMouseClicked(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                dgvclienteMousePressed(evt);
            }
        });
        ...
        txtcontra1.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txtcontra1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtcontra1KeyPressed(evt);
            }
        });
        getContentPane().add(txtcontra1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 320, -1));

        txtusuario1.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txtusuario1.setPlaceholder("Correo");
        ...
        getContentPane().add(txtusuario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, 260, -1));
    ...
    private void dgvclienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dgvclienteMouseClicked
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_dgvclienteMouseClicked

    private void dgvclienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dgvclienteMousePressed

        // TODO add your handling code here:

    }//GEN-LAST:event_dgvclienteMousePressed
...
//        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_oficial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_oficial().setVisible(true);
            }
        });
    }
    ...
    private rojerusan.RSTableMetro dgvcliente;
    ...
    private rojeru_san.RSMTextFull txt_nombre_usuario;
    private rojeru_san.RSMPassView txtcontra1;
    private rojeru_san.RSMTextFull txtusuario1;
