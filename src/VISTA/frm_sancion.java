 ...
 * @author lab-1 pc15
 */
public class frm_sancion extends javax.swing.JFrame {
    ...
    c_sancion ocSancion = new c_sancion();
    ...
    void listar_sancion(String dato) {
        try {
            modelo = ocSancion.ListarSancion(dato);
    ...
    void insertar() {
        try {
            if (txt_monto.getText().isEmpty() || txt_sancion.getText().isEmpty()) {
                ...
                ocSancion.insertarSancion(txt_sancion.getText(), Double.parseDouble(txt_monto.getText()),fechastring);
            }
        } catch (Exception e) {
        }
    }
    ...
    void recuperar()  {
        ...
        txt_sancion.setText(modelo.getValueAt(select, 1).toString());
        txt_monto.setText(modelo.getValueAt(select, 2).toString());
    ...
    void modificar() {
        try {
            if (txt_id.getText().isEmpty() || txt_monto.getText().isEmpty() || txt_sancion.getText().isEmpty()) {
                ...
                ocSancion.modificarSancion(txt_id.getText(), txt_sancion.getText(), Double.parseDouble(txt_monto.getText()),fechastring);
            }
    ...
    void eliminar() {
        try {
            ...
            int select=tabla.getSelectedRow();
            if (select >= 0) {
                ocSancion.eliminarSancion(modelo.getValueAt(select, 0).toString());
    ...
    private void initComponents() {
        ...
        txt_sancion = new rojeru_san.RSMTextFull();
        txt_monto = new rojeru_san.RSMTextFull();
        ...
        txt_id.setPlaceholder("id sancion");
        ...
        txt_sancion.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_sancion.setPlaceholder("sancion");
        txt_sancion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_sancionActionPerformed(evt);
            }
        });
        txt_sancion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_sancionKeyPressed(evt);
            }
        });
        getContentPane().add(txt_sancion, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 80, 260, -1));

        txt_monto.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_monto.setPlaceholder("monto $");
        ...
        getContentPane().add(txt_monto, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, 220, -1));
        ...
        getContentPane().add(txtdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 130, 270, 40));
    ...
    private void txt_sancionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_sancionKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_sancionKeyPressed
    ...
    private void txt_sancionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_sancionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_sancionActionPerformed
...
//        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_sancion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_sancion().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.RSMTextFull txt_monto;
    private rojeru_san.RSMTextFull txt_sancion;
