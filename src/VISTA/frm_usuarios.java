...
public class frm_usuarios extends javax.swing.JFrame {
    ...
    void listar_Usuario(String dato) {
        try {
            modeloU = ocUsuario.ListarUsuario(dato);
            tabla.setModel(modeloU);
        } catch (Exception e) {
            
             Mensaje_Dialogo2 myDialogo = new Mensaje_Dialogo2(this, true,"error al listar usurio" + e);
        }
    }

    void insertar_usuario() {
        try {
            if (txt_nombre.getText().isEmpty() || cbo_tipo.getSelectedItem().toString().equals("Seleccione...") || txt_correo.getText().isEmpty() || txt_contraseña.getText().isEmpty()) {
                
                 Mensaje_Dialogo2 myDialogo = new Mensaje_Dialogo2(this, true, "complete los campos");
            } else {
                ocUsuario.insertarUsuario(txt_nombre.getText(), cbo_tipo.getSelectedItem().toString(), txt_correo.getText(), txt_contraseña.getText());
            }
        } catch (Exception e) {
        }
    }
    ...
    void recuperar_usuario() {
        ...
        txt_id.setText(modeloU.getValueAt(select, 0).toString());
        txt_nombre.setText(modeloU.getValueAt(select, 1).toString());
        cbo_tipo.setSelectedItem(modeloU.getValueAt(select, 2).toString());
        txt_correo.setText(modeloU.getValueAt(select, 3).toString());
        txt_contraseña.setText(modeloU.getValueAt(select, 4).toString());
    ...
    void modificar() {
        try {
            if (txt_nombre.getText().isEmpty() || cbo_tipo.getSelectedItem().toString().equals("Seleccione...") || txt_correo.getText().isEmpty() || txt_contraseña.getText().isEmpty()) {
                ...
                ocUsuario.modificarUsuario(txt_id.getText(), txt_nombre.getText(), cbo_tipo.getSelectedItem().toString(), txt_correo.getText(), txt_contraseña.getText());
            }
    ...
    void eliminar() {
        try {
            ...
            if (sselect >= 0) {
                ocUsuario.eliminarUsuario(modeloU.getValueAt(sselect, 0).toString());
            } else {
    ...
    private void initComponents() {
        ...
        txt_contraseña = new rojeru_san.RSMPassView();
        ...
        getContentPane().add(lcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, -1, 40));
        ...
        cbo_tipo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cbo_tipo.setForeground(new java.awt.Color(50, 105, 125));
        cbo_tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione...", "Administrador", "Invitado", " " }));
        cbo_tipo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 176, 202), 2));
        getContentPane().add(cbo_tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 90, 240, 40));

        txt_nombre.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_nombre.setPlaceholder("Nombre Usuario");
        txt_nombre.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_nombreKeyPressed(evt);
            }
        });
        getContentPane().add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 90, 320, -1));
        ...
        txt_contraseña.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_contraseña.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_contraseñaKeyPressed(evt);
            }
        });
        getContentPane().add(txt_contraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, 320, -1));

        txt_id.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        txt_id.setPlaceholder("id usuario");
        ...
        getContentPane().add(txt_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 150, 180, -1));

        txt_correo.setFont(new java.awt.Font("Candara Light", 1, 14)); // NOI18N
        ...
        getContentPane().add(txt_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, 260, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 80, -1, -1));
...
//        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
           Mensaje_Dialogo2 myDialogo = new Mensaje_Dialogo2(this, true, "hola");
    ...
    private rojeru_san.RSMPassView txt_contraseña;
